...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
  ...
  <h2 style = "font-family: 'Anonymous Pro', monospace; "><img src="../Images/favicon64.jpg" alt="" /> Nghiệp vụ bán hàng</h2>
       ...
       <a href="Default.aspx?id=dmcang">  -Nhân viên kinh doanh <br /> Kế toán bán hàng</font></a></section>
   <section class="productlist-card"> <br />
<a href="Default.aspx?id=dmcang">  Kế toán bán hàng</a></section>
   <section class="productlist-card"><br /> 
       <a href="Default.aspx?id=dmcang">  Kế toán thanh toán</a></section>
   <section class="productlist-card"><br /> 
      <a href="Default.aspx?id=dmcang">  Kế toán bán hàng</a></section>
