<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Main/Master.Master" Inherits="ISWIFT.Sys.Web.APage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="server">
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5 ml-auto mb-5 order-md-2" data-aos="fade">
            <img src="../Js/Schema/images/img_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('../Js/Schema/images/hero_bg_4.jpg');">
      <div class="container">
    ...
    <div class="site-section border-bottom">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person">
              <img src="../Js/Schema/images/person_2.jpg" alt="Image" class="img-fluid rounded mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person">
              <img src="../Js/Schema/images/person_3.jpg" alt="Image" class="img-fluid rounded mb-5">
              <h3>Brandon Sharp</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person">
              <img src="../Js/Schema/images/person_4.jpg" alt="Image" class="img-fluid rounded mb-5">
              <h3>Connor Hodson</h3>
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="../Js/Schema/images/person_3.jpg" alt="Image" class="img-fluid mb-3">
                <p>John Smith</p>
              </figure>
              <blockquote>
